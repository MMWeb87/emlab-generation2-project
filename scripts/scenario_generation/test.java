...
//		interconnectorNetherlandsGermanyTimeSeries.setStart(4450);
		...
		minCo2PriceTrend.setIncrement({minCo2PriceIncreament});
		...
		reps.emlabModel.setEmpiricalPreferenceActive({empiricalPreferences});
		...
		reps.emlabModel.setRenewableTenderSchemeImplemented({policyTenderImplemented});
		...
		renewableSupportSchemeNL1.setSupportSchemePhaseOutTick({tenderNlPhaseoutOnshore});
		...
		renewableSupportSchemeNL2.setSupportSchemePhaseOutTick({tenderNlPhaseoutOffshore});
		...
		renewableSupportSchemeNL3.setSupportSchemePhaseOutTick({tenderNlPhaseoutPV});
		...
		renewableSupportSchemeDE1.setSupportSchemePhaseOutTick({tenderDePhaseoutOnshore});
		...
		renewableSupportSchemeDE2.setSupportSchemePhaseOutTick({tenderDePhaseoutOffshore});
		...
		renewableSupportSchemeDE3.setSupportSchemePhaseOutTick({tenderDePhaseoutPV});
